-- 0023 — Ajout de l'Article 6 bis (remboursement commission si rétractation client)
--        dans la fonction de secours (texte = modèle front à jour).
...
Article 6 bis – Remboursement de la commission en cas de rétractation du Client
Si, après que le Partenaire a réglé à CELEXIA la commission prélevée sur l’acompte, le Client exerce son droit de rétractation ou annule le devis signé, de sorte que l’Affaire n’aboutit pas et que le Partenaire restitue au Client l’acompte qu’il avait perçu, CELEXIA s’engage à rembourser au Partenaire l’intégralité de la commission correspondante.
Le remboursement intervient par virement bancaire dans un délai de 15 jours à compter de la justification, par le Partenaire, de la rétractation (ou de l’annulation) du Client et de la restitution de l’acompte. Aucune commission n’est due à CELEXIA sur une Affaire qui n’a pas abouti en raison de la rétractation du Client.
