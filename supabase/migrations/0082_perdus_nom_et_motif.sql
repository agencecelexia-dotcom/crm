-- ============================================================
--  0082 — La vue « Perdus » identifie enfin les dossiers.
--
--  Audit §8 : aucun nom de client dans cette vue, et le motif restait en
--  texte libre. Les 44 dossiers perdus étaient donc non identifiables et non
--  exploitables statistiquement. On expose le nom (sous la même condition de
--  contrat signé que le pipe actif) et le motif normalisé de 0079.
-- ============================================================
