-- ============================================================
--  0081 — Le fil de discussion remonte dans l'espace artisan.
--
--  0080 a ouvert l'écriture à l'agence, mais get_espace_artisan ne renvoyait
--  ni `lu_at` ni l'identifiant des messages : l'artisan ne pouvait donc pas
--  distinguer une consigne de l'agence de sa propre saisie, ni accuser
--  réception. Chaque chantier expose aussi `non_lus`, pour afficher une
--  pastille sans charger tous les fils.
--
--  Définition régénérée depuis la base puis patchée : la fonction porte
--  désormais sept couches successives.
-- ============================================================
